package com.kfd.cloudgallery.manager.sharding;
...
public class DynamicShardingManager {
    ...
    private static final String DATABASE_NAME = "cloud_gallery"; // 配置文件中的数据库名称
    ...
    private void updateShardingTableNodes() {
        ...
        // cloud_gallery.picture_112321321,cloud_gallery.picture_1123213123
        String newActualDataNodes = tableNames.stream()
                .map(tableName -> "cloud_gallery." + tableName) // 确保前缀合法
